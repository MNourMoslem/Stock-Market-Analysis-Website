...
def read_country():
    ...
    COUNTRY_FILE_PATH = os.path.join(DATA_DIR, "stock_country.csv")
...
def read_sector():
    func_name = inspect.currentframe().f_code.co_name
    SECTOR_FILE_PATH = os.path.join(DATA_DIR, "stock_sector.csv")
...
def read_industry():
    func_name = inspect.currentframe().f_code.co_name
    INDUSTRY_FILE_PATH = os.path.join(DATA_DIR, "stock_industry.csv")
...
def read_info():
    func_name = inspect.currentframe().f_code.co_name
    INFO_FILE_PATH = os.path.join(DATA_DIR, "stock_info.csv")
...
def read_history():
    func_name = inspect.currentframe().f_code.co_name
    HISTORY_FILE_PATH = os.path.join(DATA_DIR, "stock_history.csv")
